{
  ...
  pkgs ? import (builtins.getFlake "https://flakehub.com/f/NixOS/nixpkgs/0.2605.1004881") {
    inherit system;
  },
...
let
  ...
  workspaceVendor = rustPlatform.fetchCargoVendor {
    src = ./.;
    hash = "sha256-VM9Exn74hYiYxEF/Bzhkl4EwtmnYN7MxjBdz2LCiuJY=";
  };
...
rustPlatform.buildRustPackage {
  pname = "nix-wasm-builder-input-srcs-test";
  version = "0";
  ...
  buildPhase = ''
    RUSTFLAGS="-L ${wasiSdk}/share/wasi-sysroot/lib/wasm32-wasip1" \
      cargo build --release -p nix-wasm-builder-input-srcs-test \
  ...
  installPhase = ''
    ...
    ${pkgs.lib.getExe pkgs.wasm-tools} print $out/nix_wasm_builder_input_srcs_test.wasm > $out/input_srcs_test.wat
  '';
